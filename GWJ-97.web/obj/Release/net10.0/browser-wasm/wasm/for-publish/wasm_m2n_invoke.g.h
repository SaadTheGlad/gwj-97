...
static void
wasm_invoke_liiii (void *target_func, MonoInterpMethodArguments *margs)
{
    typedef int64_t (*T)(int arg_0, int arg_1, int arg_2, int arg_3);
    T func = (T)target_func;
    int64_t res = func (mono_wasm_interp_method_args_get_iarg (margs, 0), mono_wasm_interp_method_args_get_iarg (margs, 1), mono_wasm_interp_method_args_get_iarg (margs, 2), mono_wasm_interp_method_args_get_iarg (margs, 3));
...
static void
wasm_invoke_vilii (void *target_func, MonoInterpMethodArguments *margs)
{
    typedef void (*T)(int arg_0, int64_t arg_1, int arg_2, int arg_3);
    T func = (T)target_func;
    func (mono_wasm_interp_method_args_get_iarg (margs, 0), mono_wasm_interp_method_args_get_larg (margs, 1), mono_wasm_interp_method_args_get_iarg (margs, 3), mono_wasm_interp_method_args_get_iarg (margs, 4));
}
