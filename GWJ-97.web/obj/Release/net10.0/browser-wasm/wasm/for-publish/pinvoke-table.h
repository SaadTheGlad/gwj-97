...
wasm_native_to_interp_System_Private_CoreLib_System_Threading_ThreadPool_BackgroundJobHandler () {
    ...
    if (!(InterpEntry_T1)wasm_native_to_interp_ftndescs [1].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Threading", "ThreadPool", "BackgroundJobHandler", 100670081, 0);
    }
...
wasm_native_to_interp_System_Private_CoreLib_System_Globalization_CalendarData_EnumCalendarInfoCallback (void * arg0, void * arg1) {
    ...
    if (!(InterpEntry_T13)wasm_native_to_interp_ftndescs [13].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Globalization", "CalendarData", "EnumCalendarInfoCallback", 100668481, 2);
    }
...
godotsharp_game_main_init (void * arg0, void * arg1, void * arg2, int32_t arg3) {
    ...
    if (!(InterpEntry_T30)wasm_native_to_interp_ftndescs [30].func) {
        mono_wasm_marshal_get_managed_wrapper ("GWJ-97", "GodotPlugins.Game", "Main", "InitializeFromGameProject", 100663732, 4);
    }
...
wasm_native_to_interp_System_Private_CoreLib_System_Threading_TimerQueue_TimerHandler () {
    ...
    if (!(InterpEntry_T46)wasm_native_to_interp_ftndescs [46].func) {
        mono_wasm_marshal_get_managed_wrapper ("System.Private.CoreLib", "System.Threading", "TimerQueue", "TimerHandler", 100670118, 0);
    }
...
static UnmanagedExport wasm_native_to_interp_table[] = {
    ...
    {"BackgroundJobHandler#0:System.Private.CoreLib:System.Threading:ThreadPool", 100670081, wasm_native_to_interp_System_Private_CoreLib_System_Threading_ThreadPool_BackgroundJobHandler},
    ...
    {"EnumCalendarInfoCallback#2:System.Private.CoreLib:System.Globalization:CalendarData", 100668481, wasm_native_to_interp_System_Private_CoreLib_System_Globalization_CalendarData_EnumCalendarInfoCallback},
    ...
    {"InitializeFromGameProject#4:GWJ-97:GodotPlugins.Game:Main", 100663732, godotsharp_game_main_init},
    ...
    {"TimerHandler#0:System.Private.CoreLib:System.Threading:TimerQueue", 100670118, wasm_native_to_interp_System_Private_CoreLib_System_Threading_TimerQueue_TimerHandler},
